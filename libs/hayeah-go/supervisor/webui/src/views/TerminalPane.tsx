import { TerminalPane as LibTerminalPane } from "@hayeah/termui";
...
// the padding + bg; @hayeah/termui's inner canvas host fills the
// space.
//
...
// wheel handler live inside @hayeah/termui's mountTerminal.
