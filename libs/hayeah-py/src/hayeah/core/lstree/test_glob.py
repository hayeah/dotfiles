"""Glob tests driven by the shared JSON vectors in libs/testdata/lstree_glob.json."""
...
from hayeah.core.lstree.glob import GlobError, glob_match, globs_match

# libs/hayeah-py/src/hayeah/core/lstree -> libs/
_LIBS_ROOT = Path(__file__).resolve().parents[5]
_VECTORS = json.loads((_LIBS_ROOT / "testdata" / "lstree_glob.json").read_text())
